...
import { use } from "react";
 ...
 export const updateCartItemQuantity= createAsyncThunk("cart/updateCartItemQuantity",async({productId,quantity,size,color},{rejectWithValue})=>{
    try{
 ...
 //Merge guest cart intro user cart
